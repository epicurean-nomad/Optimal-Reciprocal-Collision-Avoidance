...
namespace RVO {
	...
	void Agent::computeNewVelocity()
	{
		...
		for (size_t i = 0; i < agentNeighbors_.size(); ++i) {
			...
			line.normal = Vector2(-line.direction.y(),line.direction.x());
	...
	void Agent::update()
	{
		...
		position_ += newVelocity_ * sim_->timeStep_;
		// position_ += (velocity_ * sim_->timeStep_) + 0.5 * ((newVelocity_ - velocity_)/sim_->timeStep_) * sqr(sim_->timeStep_);
